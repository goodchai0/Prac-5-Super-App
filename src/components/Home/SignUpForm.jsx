    ...
    <div className={styles.body}>
      ...
      <form>
        ...
        <input
          ...
          style={userNameError ?{ border: "2px solid red"}:{}}
        ></input>
        {userNameError ? (
          <p className={styles.error}>Please fill correctly</p>
        ) : (
        ...
        <input
          ...
          name="mail"
          placeholder="Email"
          style={mailError ?{ border: "2px solid red"}:{}}
        ></input>
        {mailError ? (
          <p className={styles.error}>Please fill correctly</p>
        ) : (
        ...
        <input
          ...
          name="mobile"
          placeholder="Mobile"
          style={mobileError ?{ border: "2px solid red"}:{}}
        ></input>
        {mobileError ? (
          <p className={styles.error}>Please fill correctly</p>
        ) : (
        ...
        <label>
          <input
            ...
            type="checkbox"
            name="check"
            style={signUpError ?{ border: "2px solid red"}:{}}
          />
